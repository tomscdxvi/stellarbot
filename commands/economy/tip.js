    ...
    run: async({ interaction }) => {
        ...
        try {
            ...
            if(tipAmount > balance) {
                ...
                return await interaction.editReply(`You do not have enough to send :coin: ${tipAmount}`);
            }
            ...
            if(interaction.user.id === user.id) {
                ...
                return await interaction.editReply(`You cannot send coins to yourself`);
            }
            ...
            if(!getUserData) {
                ...
                return await interaction.editReply(`${user.username} is not in the system...`);
            }
            ...
            interaction.editReply(`You have sent :coin: ${tipAmount.toLocaleString()} to ${user.username}`);    
        } catch(error) {
