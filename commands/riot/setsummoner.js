...
module.exports = {
            ...
            if (user) {
                if(user.puuid == null) {
                    try {
                        ...
                        await interaction.editReply("Summoner has been saved onto your Discord account, you can now use the other commands!");
                    } catch(error) {
                    ...
                    await interaction.editReply("There is an existing summoner associated with your Discord account...");
                }
            } else {
                user = new User({
                    userId: interaction.member.id
    ...
    data: {
        name: 'setsummoner',
        'description': 'Set your summoner in-game name and tagline to your account',
        options: [
            {
                name: 'name',
