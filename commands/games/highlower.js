...
// Action Buttons
const higherButton = new ButtonBuilder().setLabel('Higher').setStyle(ButtonStyle.Primary).setCustomId('higher-button');
const lowerButton = new ButtonBuilder().setLabel('Lower').setStyle(ButtonStyle.Success).setCustomId('lower-button');
            ...
            collector.on('collect', async (interaction) => {
                ...
                if(interaction.customId === 'higher-button') {
                    if (interaction.user != interaction.member) {
                        ...
                        return await interaction.editReply(`You cannot click within this event...`);
                    } else {
